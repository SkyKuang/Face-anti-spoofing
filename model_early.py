...
class Model(nn.Module):
    def __init__(self,pretrained=False, num_classes=2):
        ...
        self.ycb_selayer = SElayer(64)

        self.main_layer2 = self.main_resnet.layer2
        self.main_layer3 = self.main_resnet.layer3
