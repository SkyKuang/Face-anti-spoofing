...
class Model(nn.Module):
    ...
    def forward(self, rgb_img, depth_img, ir_img, hsv_img, ycb_img):
        ...
        rgb_feat3 = self.rgb_selayer(rgb_feat2)
        ...
        main_feat = torch.cat((rgb_feat3,depth_feat3),1)
        main_feat = torch.cat((main_feat,ir_feat3),1)
        main_feat = torch.cat((main_feat,hsv_feat3),1)
        main_feat = torch.cat((main_feat,ycb_feat3),1)
